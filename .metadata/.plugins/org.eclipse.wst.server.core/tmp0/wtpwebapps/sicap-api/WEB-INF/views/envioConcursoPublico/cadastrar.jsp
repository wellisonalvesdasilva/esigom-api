...
<tiles:insertDefinition name="DefaultTemplate">
	<tiles:putAttribute name="body">
		<div ng-controller="cadastrarEnvioConcursoPublicoController">

			<h1 class="one">
				<span>Cadastrar Envio de Concurso</span>
			</h1>
			...
			<form id="objNovoEnvio" method="POST">
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-4">
						<div class="form-group">
							<label> Regime Jurídico:</label> <select
					...
					<div class="col-lg-3 col-md-3 col-sm-4">
						<div class="form-group">
							<label> Veículo de Publicação do Edital:</label> <select
					...
					<div class="col-lg-3 col-md-3 col-sm-4">
						<div class="form-group">
							<label>Prazo de Validade (Meses):</label> <input maxlength="30"
								ng-model="concurso.prazoValidade"
					...
					<div class="col-lg-3 col-md-3 col-sm-4">
						<div class="form-group">
							<label>Número do Edital:</label> <input maxlength="30"
					...
					<div class="col-lg-2 col-md-3 col-sm-4">
						<div class="form-group">
							<label>Ano do Edital:</label> <input maxlength="30"
					...
					<div class="col-lg-4 col-md-3 col-sm-4">
						<div class="form-group">
							<label>Descrição do Edital:</label> <input maxlength="30"
								ng-model="concurso.descricao"
					...
					<div class="col-lg-3 col-md-3 col-sm-4">
						...
						<div class="input-group">
							<input type='text' autocomplete="off"
								ng-model='concurso.dataPublicacaoEditalView'
				...
				<div class="row align-right" style="margin: 0px;">
					...
					<div class="btn-group" role="group">
						<button ng-click="cadastrar()" id="cadastrar"
			...
			<script>
				...
				var controllerId = "cadastrarEnvioConcursoPublicoController";

				angular.module("app").controller(
						controllerId,
						[ "$scope",  'toastr', "envioConcursoService",  
								cadastrarEnvioConcursoPublicoController ]);				
				
				function cadastrarEnvioConcursoPublicoController($scope, toastr,
					...
					// Chamada Javascript
						envioConcursoService.cadastrar(vm.concurso).then(
								function(result) {
