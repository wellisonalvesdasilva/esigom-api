	...
	<tiles:putAttribute name="body">
			...
			<div class="row">
				<div class="col-lg-2 col-md-3 col-sm-4">
					<div class="form-group">
						<label>CBO Cargo</label> <input placeholder='Número Lei'
				...
				<div class="col-lg-2 col-md-3 col-sm-4">
					<div class="form-group">
						<label>Dígito Verificador</label> <input placeholder='Número Lei'
							max='99999' type='number' name='numeroLei' id='numeroLei'
							class="form-control" value='${(fn:escapeXml(param.numeroLei))}' />
					</div>
				</div>
				<div class="col-lg-2 col-md-3 col-sm-4">
					<div class="form-group">
						<label>Valor da Verba</label> <input placeholder='Número Lei'
							max='99999' type='number' name='numeroLei' id='numeroLei'
							class="form-control" value='${(fn:escapeXml(param.numeroLei))}' />
					</div>
				</div>
				<div class="col-lg-2 col-md-3 col-sm-4">
					<div class="form-group">
						<label>Tipo da Verba</label> <input placeholder='Número Lei'
							max='99999' type='number' name='numeroLei' id='numeroLei'
							class="form-control" value='${(fn:escapeXml(param.numeroLei))}' />
					</div>
				</div>
				<div class="col-lg-2 col-md-3 col-sm-4">
					<div class="form-group">
						<label>Legislação</label> <input placeholder='Número Lei'
							max='99999' type='number' name='numeroLei' id='numeroLei'
							class="form-control" value='${(fn:escapeXml(param.numeroLei))}' />
					</div>
				</div>
		...
		<div class="row" style="margin: 0px;">
			<table class="table table-striped table-responsive"
				...
				<tbody>
					<c:forEach var="it" items="${retornoPesquisaVerba}"
						varStatus="status">
						<tr>
