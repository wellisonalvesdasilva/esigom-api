				...
				<div id="navbar" class="navbar-collapse collapse text-left">
					<ul class="nav navbar-nav" style="margin-top: 15px;">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							aria-expanded="false">Importações</a>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown" role="button" aria-haspopup="true"
							aria-expanded="false">Retificações</a>
							<ul class="dropdown-menu">
								<li><a
						...
						<%--<li><a
							href="${pageContext.request.contextPath}/manager/intimacao/">Intimações
								<tce:alertaIntimacao />
						</a></li>--%>
						<li><a
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<%--<li><a
									href="${pageContext.request.contextPath}/manager/manterManual">Atualização
										Manual/Tabela</a></li>--%>
							</ul></li>
					</ul>
